...
| **③a/③b MoE** | MoE dispatch / combine | All-to-All ×2 | 前/反向 | 专家分到不同卡，token 必须**去专家所在卡**算、再送回 | [§6.5](#65-moe--专家并行ep的通信为什么是-all-to-all)、[02.7 §6](./02.7-上下文并行与专家并行.md) |
...
> 本节只交代"MoE 为何是 A2A、落在图谱哪一格"。负载不均、容量因子、共享专家、Ring/2D 通信优化等完整推导见 [02.7 §5–§8](./02.7-上下文并行与专家并行.md)。
